 ...
 * @LastEditTime: 2023-12-29 23:06:27
      ...
      <el-form label-position="right" label-width="60px" :model="formValue1">
        <div class="card">
          ...
          <el-form-item label="name">
            <el-input v-model="formValue1.name" size="small" />
          </el-form-item>
        </div>
        <div class="card">
          <div class="card-header">
          ...
          <el-form-item label="路径">
            <el-input v-model="formValue1.path" size="small" />
          </el-form-item>
        </div>
        <div class="card">
          <div class="card-header">
        ...
        <div class="card">
          ...
          <el-form-item label-width="20px">
            <el-checkbox v-model="formValue1.autoplay" label="自动播放" />
          </el-form-item>
          <el-form-item label-width="20px">
            <el-checkbox v-model="formValue1.loop" label="循环" />
          </el-form-item>
        </div>
      </el-form>
      <div class="card">
