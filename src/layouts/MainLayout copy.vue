                  ...
                  >
                    <q-list dense style="min-width: 100px">
                      <q-item>
                        ...
                        >
                          <q-list dense style="min-width: 100px">
                            <q-item
                              clickable
                              @click="handleAddSceneType(1, index)"
                            >
                              <q-item-section>
                                <div>
                                  <q-icon
                            ...
                            <q-item
                              clickable
                              @click="handleAddSceneType(2, index)"
                            >
                              <q-item-section>
                                <div>
                                  <q-icon
                            ...
                            <q-item
                              clickable
                              @click="handleAddSceneType(3, index)"
                            >
                              <q-item-section>
                                <div>
                                  <q-icon
                            ...
                            <q-item
                              clickable
                              @click="handleAddSceneType(4, index)"
                            >
                              <q-item-section
                                ><div>
                                  <q-icon
                            ...
                            <q-item
                              clickable
                              @click="handleAddSceneType(5, index)"
                            >
                              <q-item-section
                                ><div>
                                  <q-icon
                            ...
                            <q-item
                              clickable
                              @click="handleAddSceneType(6, index)"
                            >
                              <q-item-section
                                ><div>
                                  <q-icon
                            ...
                            <q-item
                              clickable
                              @click="handleAddSceneType(7, index)"
                            >
                              <q-item-section
                                ><div>
                                  <q-icon name="bi-mic" class="iconstyle" />声音
                      ...
                      <q-item v-close-popup>
                        <q-item-section @click="viewOpenFile"
                          >创建副本
                        </q-item-section>
                      </q-item>
                      <q-item v-close-popup>
                        <q-item-section @click="viewSaveFile"
                          >重命名</q-item-section
                        >
                      </q-item>
                      <q-separator />
                      <q-item v-close-popup v-if="sceneList.length > 1">
