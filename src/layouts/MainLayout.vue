...
<template>
  <div>
    <q-layout view="hHh lpR lFr">
          ...
          <div class="q-ml-md cursor-pointer non-selectable">
            ...
            <q-menu auto-close dark>
              <q-list dense style="min-width: 100px">
                ...
                <q-item
                  clickable
                  @click="scene.handleAddSceneType('dialog', scene.sceneIndex)"
                >
                  <q-item-section
                    ><div>
                ...
                <q-item
                  clickable
                  @click="scene.handleAddSceneType('button', scene.sceneIndex)"
                >
                  <q-item-section
                    ><div>
      ...
      <!-- 左侧抽屉 -->
      <div v-if="scene.projectList.length">
        <MainLayoutLeft />
        <MainLayoutRight />
      </div>
      <el-empty
        v-else
        description="暂无项目，请先新建项目吧"
